...
export async function GET() {
  try {
    const fiwareUrl = `${process.env.FIWARE_URL}/ngsi-ld/v1/entities?type=RoadSegment&q=statusDescription!=1.0&options=keyValues&limit=1000`;
    ...
    console.error("Error in /api/get-affected-roads:", error);
